...
\section{Solution}
 ...
 \\
Let, \textbf{P}(given point) = \begin{pmatrix}
    3\\
    8
    \end{pmatrix} \\
...
Let, \textbf{R} be the image point. 
\\
...
Let vector \textbf{n} = \begin{pmatrix}
    ...
    \end{pmatrix}
\\ \\
Let m be the directional vector along the line, x + 3y = 7.\\
...
\begin{equation}
    2\vec{Q} = \vec{P} + \vec{R}
\end{equation}
Where, \textbf{Q} is the point on the line x + 3y = 7. 



\\
Hence the reflection vector \textbf{R} is given as, 
\begin{equation}
...
\end{equation}
 ...
 Norm, \||\vec{n}\|| = $\sqrt[2]{1^2+3^2}$ = $\sqrt[2]{10}$ \\
 
Substituting these values in equation (2.0.2) we get,\\ 
\begin{equation}
