...
\textbf{Q}(point on mirror) = \begin{pmatrix}
    x2\\
    y2
    \end{pmatrix} \\ 
    
\textbf{R}(image point) = \begin{pmatrix}
    x3\\
    y3
    \end{pmatrix}
\\
...
Let vector \textbf{n} = \begin{pmatrix}
    ...
    \end{pmatrix}
\\ \\
Let m be the directional vector along the line, ax + by = c.\\
...
\end{equation}
 ...
 Hence, substituting the values of x1 = 3, y1 = 8, a = 1, b = 3 and c = 7 we get,\\ 
 \textbf{P}(given point)  = \begin{pmatrix}
    3 \\ 
    8
    \end{pmatrix} \\ 
